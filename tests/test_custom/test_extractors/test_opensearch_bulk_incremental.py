...
from src.components.extractors.opensearch import OpensearchExtractor


class TestOpensearchBulkIncremental(unittest.TestCase):
    ...
    def test_bulk_extraction_mode(self):
        ...
        extractor = OpensearchExtractor(self.mock_client, config)
    ...
    @patch("src.components.extractors.opensearch.Variable")
    ...
    def test_incremental_mode_requires_incremental_field(self):
        ...
        with self.assertRaises(ValueError) as cm:
            OpensearchExtractor(self.mock_client, config)
